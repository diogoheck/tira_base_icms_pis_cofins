        ...
        if registro == 'C170':
            ...
            if CST_Pis == '01':
                ...
                if valor_icms:
                    ...
                    print(valor_icms, vl_bc_pis,
                          vl_bc_cofins, aliq_pis, aliq_cofins, vl_nova_bc_pis, vl_nova_bc_cofins, valor_novo_pis, valor_novo_cofins)
                    ...
                    novo_sped.append('|'.join(nova_lista))
                    passou = True
        if not passou:
